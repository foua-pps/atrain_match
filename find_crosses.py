...
# SNO executable
SNO_EXECUTABLE = os.environ.get('SNO_EXECUTABLE', "/data/proj/saf/ejohansson/SNO_tools/snotimes")
# Time window between satellite data reception time and sat1-sat2 crossing time, in seconds
SATELLITE_CROSS_RECEPTION_TIME_WINDOW = int(os.environ.get('SATELLITE_CROSS_RECEPTION_TIME_WINDOW', 60*60))
    ...
    for l in f.readlines():
        try:
            ...
            try:
                ...
                satellite1 = a[0].lower()
                satellite2 = a[1].lower()
