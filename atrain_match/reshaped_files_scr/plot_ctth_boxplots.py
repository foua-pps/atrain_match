...
def investigate_nn_ctth_viirs():
    ...
    for ROOT_DIR, name in zip(
            [ROOT_DIR_v2014, ROOT_DIR_v2018, ROOT_DIR_nn_imager_wg, ROOT_DIR_nn_imager1, ROOT_DIR_nn_imager, ROOT_DIR_nn_imager_tuned, ROOT_DIR_v2014_old,
                ROOT_DIR_14bug, ROOT_DIR_nn_viirs, ROOT_DIR_nn_viirs_CLAY4, ROOT_DIR_nn_viirs_new, ROOT_DIR_nn_viirs_lm, ROOT_DIR_nn_imager_lm],
