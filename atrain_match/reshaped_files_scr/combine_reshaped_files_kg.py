...
SATELLITES = ["meteosat9", "meteosat10", "noaa18", "noaa19", "noaa17", "metopa", "metopb"]
...
if __name__ == '__main__':
    ...
    for satellite in SATELLITES:
        ROOT_DIR = BASE_DIR + "/{satellite}/5km/**/*%s%s*_*{truth}*.h5".format(
        ...
        for year in YEAR_LIST:
            for month in ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"]:
                ...
                if num_n > 0:
                    ...
                    if instrument not in ['avhrr', 'seviri']:
