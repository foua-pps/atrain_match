# -*- coding: utf-8 -*-
#
# atrain_match documentation build configuration file, created by
# sphinx-quickstart on Wed Nov  3 12:14:49 2010.
#
...
# Set python path to find project modules
sys.path.append('..')
...
htmlhelp_basename = 'atrain_matchdoc'
...
latex_documents = [
  ('index', 'atrain_match.tex', ur'atrain_match Documentation',
   ur'Adam Dybbroe, Karl-Göran Karlsson, Erik Johansson, Jakob Malm', 'manual'),
]
